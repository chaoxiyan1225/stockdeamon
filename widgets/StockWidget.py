...
class SuggestStock(BaseWidget):
   ...
   def initUI(self):
        ...
        self.layout0.addWidget(QLabel("%"))
        self.layout0.addWidget(QLabel("     |     "))
        self.layout0.addWidget(self.volume_label)
        self.layout0.addWidget(self.lowVolume)
        self.layout0.addWidget(QLabel("-"))
        self.layout0.addWidget(self.highVolume)
        self.layout0.addWidget(QLabel("     |     "))
        self.layout0.addWidget(self.dynamicPE_label)
        self.layout0.addWidget(self.lowDynamicPE)
        self.layout0.addWidget(QLabel("-"))
        self.layout0.addWidget(self.highDynamicPE)

        self.chipConcent_label = QLabel("筹码集中度")
        self.lowChipConcent = QLineEdit("")
        self.lowChipConcent.setMaximumWidth(80)
        self.lowChipConcent.setStyleSheet("QLineEdit{background-color:rgba(100,100,100,100); border:0px;}")

        self.hignChipConcent = QLineEdit("")
        self.hignChipConcent.setMaximumWidth(80)
        self.hignChipConcent.setStyleSheet("QLineEdit{background-color:rgba(100,100,100,100); border:0px;}")

        self.mainIn_label = QLabel("主力资金流入")
        self.lowMainIn = QLineEdit("")
        self.lowMainIn.setMaximumWidth(80)
        self.lowMainIn.setStyleSheet("QLineEdit{background-color:rgba(100,100,100,100); border:0px;}")

        self.hignMainIn = QLineEdit("")
        self.hignMainIn.setMaximumWidth(80)
        self.hignMainIn.setStyleSheet("QLineEdit{background-color:rgba(100,100,100,100); border:0px;}")

        self.mainInPercent_label = QLabel("主力流入占比")
        self.lowMainInPercent = QLineEdit("")
        self.lowMainInPercent.setMaximumWidth(80)
        self.lowMainInPercent.setStyleSheet("QLineEdit{background-color:rgba(100,100,100,100); border:0px;}")

        self.hignMainInPercent = QLineEdit("")
        self.hignMainInPercent.setMaximumWidth(80)
        self.hignMainInPercent.setStyleSheet("QLineEdit{background-color:rgba(100,100,100,100); border:0px;}")

        self.moreHignB = QLabel('是否突破前高')
        self.cb=QComboBox()
        self.cb.addItem('不限制')
        self.cb.addItem('突破前高')

        self.layout1 = QHBoxLayout()
        self.layout1.addWidget(self.chipConcent_label)
        self.layout1.addWidget(self.lowChipConcent)
        self.layout1.addWidget(QLabel("%"))
        self.layout1.addWidget(QLabel("-"))
        self.layout1.addWidget(self.hignChipConcent)
        self.layout1.addWidget(QLabel("%"))
        self.layout1.addWidget(QLabel("     |     "))
        self.layout1.addWidget(self.mainIn_label)
        self.layout1.addWidget(self.lowMainIn)
        self.layout1.addWidget(QLabel("-"))
        self.layout1.addWidget(self.hignMainIn)
        self.layout1.addWidget(QLabel("     |     "))
        self.layout1.addWidget(self.mainInPercent_label)
        self.layout1.addWidget(self.lowMainInPercent)
        self.layout1.addWidget(QLabel("%"))
        self.layout1.addWidget(QLabel("-"))
        self.layout1.addWidget(self.hignMainInPercent)
        self.layout1.addWidget(QLabel("%"))
        self.layout1.addWidget(QLabel("     |     "))
        self.layout1.addWidget(self.moreHignB)
        ...
        self.layoutX = QHBoxLayout()
        self.layoutX.addWidget(self.msg)
        self.layoutX.addWidget(self.queryButton)
        ...
        self.layoutY.addWidget(self.text)

        self.layout = QVBoxLayout()
        self.layout.addLayout(self.layout0)
        self.layout.addLayout(self.layout1)
        self.layout.addLayout(self.layoutX)
        self.layout.addLayout(self.layoutY)
